...
const Login = () => {
  ...
  return (
    <div className="w-[70%] h-full text-[#fff] flex flex-col justify-center items-center relative z-20">
      <div className="w-[70%]">
        <h1 className="text-[50px] font-bold">Hi there,</h1>
        <h2 className="text-[30px] font-semibold">Welcome to our contacts portal</h2>
      ...
      >
       ...
       <button
        ...
        <u><h2 className="text-[20px] font-semibold"><a href="">Click here to Register</a></h2></u>
       </div>
      </form>
      </div>
    </div>
